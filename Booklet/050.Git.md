...
But if you do, don't forget to have a look at the message log: error checking is attempted, and warnings are spat
out if oddities are found.
...
1. [ ] **Optional:** Checkout the branch/tag you want to deliver
